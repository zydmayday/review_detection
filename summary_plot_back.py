...
if __name__ == '__main__':
	...
	fu.get_structure()
	save_graph(get_reviews_rating_relation(fu.get_rating_list()), 'reviews_rating_2.png', plot_type='b-', use_log=[False, False],  xlabel='Percent of Reviews', ylabel='Rating')
